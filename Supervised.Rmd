...
**Remark 2:** To learn the most accurate model, it is best to use all
  ...
  set). The
  [figure-neuroblastoma-predictions.R](figure-neuroblastoma-predictions.R)
  ...
  [plots the predicted changepoints along with the train errors](figure-neuroblastoma-predictions.R). Some
