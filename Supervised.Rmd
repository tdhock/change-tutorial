...
GitHub repository: https://github.com/tdhock/change-tutorial

Download this
[Rmd](https://raw.githubusercontent.com/tdhock/change-tutorial/master/Supervised.Rmd)
and follow along by executing the code blocks using Rstudio (may have
version problems) or [Rcloud](https://rcloud.social/edit.html)
(probably fewer problems).
...
**Exercise during class:** can you think of any other features which
...
algorithms, and see if you can get better results.
